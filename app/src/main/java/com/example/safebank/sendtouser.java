...
public class sendtouser extends AppCompatActivity {
    ...
    private void showData(String phonenumber) {
        ...
        Cursor cursor = new DBHandler(this).readselectuserdata(phonenumber);
        ...
        adapter = new CustomerAd_sendtouser(sendtouser.this, modelList_sendtouser);
        mRecyclerView.setAdapter(adapter);
    }

    public void selectuser(int position) {
        selectuser_phonenumber = modelList_sendtouser.get(position).getPhoneno();
        Cursor cursor = new DBHandler(this).readparticulardata(selectuser_phonenumber);
        while(cursor.moveToNext()) {
            ...
            new DBHandler(this).insertTransferData(date, name, selectuser_name, transferamount, "Success");
            new DBHandler(this).updateAmount(selectuser_phonenumber, Dselectuser_remainingamount.toString());
            calculateAmount();
    ...
    private void calculateAmount() {
        ...
        new DBHandler(this).updateAmount(phonenumber, remainingamount);
    }
        ...
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        new DBHandler(sendtouser.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
